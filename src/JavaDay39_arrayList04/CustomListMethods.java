...
public class CustomListMethods {
	...
	public static void main(String[] args) {
		...
		doubleList.add(8.80);
		//option #1
		System.out.println(sumList(doubleList));//62.11
		//option #2
		double sum=sumList(doubleList);
		System.out.println(sum);//62.11
	...
	//	for(;;)
		...
		System.out.println(converted);//[123, 33, 128, 3]
	}
	...
	//return type double
	//param:List<Double>
	//Calculates sum of each double value and returns the retult
