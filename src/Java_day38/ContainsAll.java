...
public class ContainsAll {
	...
	public static void main(String[] args) {
		...
		//nums2.add(50);if it was false we add the nums2 here
		...
		planB.add("ping pong");
		planB.add("replit");
		//check if both have same values,ignore order
		...
		boolean b1=planA.containsAll(planB)&&planB.containsAll(planA);
