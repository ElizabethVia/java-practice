...
public class WrapperClassMethods {
	...
	public static void main(String[] args) {
		...
		int count =Integer.parseInt("325465");
		System.out.println("count: "+count);//count: 325465
		
		int count2=Integer.valueOf("54215");//unboxing
		System.out.println("count2: "+count2);//count2: 54215
