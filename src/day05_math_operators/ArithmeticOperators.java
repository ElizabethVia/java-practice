...
public class ArithmeticOperators {
	public static void main(String[] args) {
		...
		//create a variable lineOfCode and assign 50
		//you deleted 2 lines
		//decrease the value of linesOfCode and print "lines of code 48"
		...
		linesOfCode =  linesOfCode- 2; 
				...
				System.out.println("totalLinesOfCode="+linesOfCode);
				...
				//System.out.println(11 / 0);//throw error 
